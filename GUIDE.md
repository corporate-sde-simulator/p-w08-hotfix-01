...
> **Welcome to Product-Track Week 8, Hotfix 1!**
...
1. **Read the comments** at the top of `deployManager.py` - they describe the problem
...
| File | Purpose |
|------|---------|
| `deployManager.py` | The code with bugs - **fix this file** |
...
### Bug #1
**User Report / Alert:**
> "Switches traffic BEFORE health checks"
...
### Bug #2
**User Report / Alert:**
> "No automatic rollback â€” just prints error"
...
### Bug #3
**User Report / Alert:**
> "Instant 100% switch â€” should be gradual (canary)"
...
1. **Read the top comment block** in `deployManager.py` carefully - it has:
